...
export default function AboutHero() {
  ...
  return (
    <section className="relative overflow-hidden bg-[#0b2530] text-white">
      {/* Image sits in normal flow — sets section height naturally, zero cropping */}
      <img
      ...
      {/* Text content — absolutely centered over the image */}
      <div className="absolute inset-0 flex items-center z-10 py-12 md:py-16">
